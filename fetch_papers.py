...
if __name__ == "__main__":
  ...
  parser.add_argument('--search-query', type=str,
                      default='cat:cond-mat.dis-nn+OR+cat:cond-mat.mtrl-sci+OR+cat:cond-mat.other+OR+cat:cond-mat.stat-mech+OR+cat:cond-mat.str-el+OR+cat:cond-mat.supr-con',
  ...
  parser.add_argument('--wait-time', type=float, default=60.0, help='lets be gentle to arxiv API (in number of seconds)')
